import type { ProbeRequestDetails, UpstreamDefinition } from "../types/source";
...
function renderedSourceUrl(source: UpstreamDefinition, variables: DebugVariables): string {
