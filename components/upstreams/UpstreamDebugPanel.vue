...
import type { ProbeRequestDetails, UpstreamDefinition, UpstreamProbe } from "../../types/source";
import { buildSourceRequestPreview } from "../../utils/upstreamDebugUrl";
...
const keywordInputId = `upstream-debug-keyword-${instanceId.replace(/[^a-z0-9_-]/gi, "")}`;
